...
private:
 ...
 public:
    ...
    //______HELPER METHODS_______
    long initializeSum(char channel,PNG & im, unsigned int w, unsigned int h);
    long initializeSumSq(char channel,PNG & im, unsigned int w, unsigned int h);
